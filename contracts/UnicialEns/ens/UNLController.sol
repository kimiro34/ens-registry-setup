...
import "../interfaces/IUNLRegistrar.sol";
import "../interfaces/IERC20.sol";

contract UNLController is Ownable {
    ...
    // DCL Registrar
    IUNLRegistrar public registrar;
    ...
    event MaxGasPriceChanged(
        uint256 indexed _oldMaxGasPrice,
        uint256 indexed _newMaxGasPrice
    );
     ...
     */
    constructor(IERC20 _acceptedToken, IUNLRegistrar _registrar) {
        require(
            address(_acceptedToken).isContract(),
            "Accepted token should be a contract"
        );
        require(
            address(_registrar).isContract(),
